    ...
    $.supersized = function(options){
    	...
    	base._start = function(){
			...
			if (base.options.performance == 3){
				...
				base.$el.addClass('quality kenburns');	// Higher image quality
			}
		...
		base.nextSlide = function(){
			...
			if (base.options.performance == 1) base.$el.removeClass('quality kenburns').addClass('speed');	
		...
		base.afterAnimation = function(){
			...
			if (base.options.performance == 1){
		    	base.$el.removeClass('speed').addClass('quality kenburns');
			}
